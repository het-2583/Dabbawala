            ...
            <!-- <div class="row"> -->
                <!-- <div class="col-md-6"> -->
                    <div class="myLeftCtn"> 
                        ...
                        <form class="myForm text-center" action="/admin"  method="post" >
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input class="myInput" type="password" name="Pass" id="Pass" placeholder="Password" required> 
                            </div>
                            ...
                            <br>
                            <br>
                             <a href="/index">New  User !! Register Here.</a>
