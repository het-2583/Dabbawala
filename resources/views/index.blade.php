                ...
                <!-- <div class="col-md-6"> -->
                    <div class="myLeftCtn"> 
                        ...
                        <form class="myForm text-center" action="{{ route('store')}}"  method="post" >
                            ...
                            <div class="form-group">
                                <!-- <i class="fas fa-user"></i> -->
                                <input class="myInput" type="tel" placeholder="Contact Number" name="Phone" id="Phone" required> 
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="myInput" type="password" name="Pwd" id="Pwd" placeholder="Password" required> 
                            </div>
